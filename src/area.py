...
def get_country_id() -> str:
    """
    Получает по API id страны, соответствующий введенному пользователем названию страны
    :return: id страны
    """
    while True:
...
def get_region_id(country_id: str) -> str:
    """
    Получает по API id региона, соответствующий введенному пользователем названию региона
...
def get_city_id(region_id: str) -> str:
    """
    Получает по API id города, соответствующий введенному пользователем названию города
